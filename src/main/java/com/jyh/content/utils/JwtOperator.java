...
public class JwtOperator {
     ...
     * 秘钥
     */
    @Value("${jwt.tokenSecret:aaaaaaaaaabbbbbbbbbbbcccccccccccddddddd}")
    private String secret;
    /**
     * 有效期，单位秒
     * 默认2周
     */
    @Value("${jwt.expireTime:1209600}")
...
//        objectObjectHashMap.put("id", "1");
        objectObjectHashMap.put("nickname", "jyh");
        objectObjectHashMap.put("role", "admin");
//
//        // 测试1: 生成token
